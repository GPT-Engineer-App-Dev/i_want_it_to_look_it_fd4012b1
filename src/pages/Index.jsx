...
const Index = () => {
  return (
    <Container maxW="container.xl" p={4}>
      {/* Hero Section */}
      <Flex alignItems="center" justifyContent="center" direction="column" my={12} w="100%" bgGradient="linear(to-r, orange.500, yellow.500)">
        <VStack align="center" w="100%" spacing={6}>
          <Heading as="h1" fontSize="5xl" fontWeight="bold" letterSpacing="wide">
            DESUBICADOS
          </Heading>
          <Text fontSize="xl" color={useColorModeValue("orange.500", "yellow.500")} fontStyle="italic">
          ...
          <Button leftIcon={<FaPlay />} colorScheme="orange" size="lg" _hover={{ bg: "yellow.500" }}>
            Listen Now
          </Button>
        </VStack>
        <Box w={{ base: "80%", md: "50%" }} mt={{ base: 20, md: 10 }}>
          <Image src="https://images.unsplash.com/photo-1529655683826-aba9b3e77383?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwxfHx2YW4lMjBnb2doJTIwcGFpbnRpbmd8ZW58MHx8fHwxNzA0NDIyOTI2&ixlib=rb-4.0.3&q=80&w=1080" alt="Van Gogh Painting" borderRadius="lg" filter="grayscale(0.5)" />
        </Box>
      </Flex>
